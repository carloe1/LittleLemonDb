...
truncate_bookings_table = "TRUNCATE TABLE Bookings;"
truncate_employees_table = "TRUNCATE TABLE Employees;"
truncate_menu_items_table = "TRUNCATE TABLE MenuItems;"
truncate_menus_table = "TRUNCATE TABLE Menus;"
truncate_orders_table = "TRUNCATE TABLE Orders;"
...
cursor.execute(truncate_menu_items_table)
cursor.execute(insert_menuitems)
connection.commit()

# Populate MenuItems table
cursor.execute(truncate_menus_table)
cursor.execute(insert_menu)
connection.commit()

# Populate Bookings table
cursor.execute(truncate_bookings_table)
cursor.execute(insert_bookings)
connection.commit()

# Populate Orders table
cursor.execute(truncate_orders_table)
cursor.execute(insert_orders)
connection.commit()

# Populate Employees table
cursor.execute(truncate_employees_table)
